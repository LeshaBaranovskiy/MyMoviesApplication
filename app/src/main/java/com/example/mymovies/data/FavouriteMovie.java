...
public class FavouriteMovie extends Movie {
    public FavouriteMovie(int uniqueId, int id, double voteCount, String title, String originalTitle, String overview, String posterPath, String bigPosterPath, String backdropPath, double voteAverage, String releaseDate) {
